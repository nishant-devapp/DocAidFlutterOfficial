        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              Text('Doctor Schedule', style: TextStyle(fontSize: deviceHeight * 0.028, fontWeight: FontWeight.w600),),
              ...
              ElevatedButton(
                ...
                child: Text('Submit', style: TextStyle(color: Colors.white, fontSize: deviceHeight * 0.022,),),
              )
            ],
          ),
        ),
