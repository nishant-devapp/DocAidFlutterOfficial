...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Map<String, String>> _icons = [
    {'unselected': 'assets/svg/bottom_nav_unselected_dashboard.svg', 'selected': 'assets/svg/bottom_nav_selected_dashboard.svg'},
    {'unselected': 'assets/svg/bottom_nav_unselected_clinic.svg', 'selected': 'assets/svg/bottom_nav_selected_clinic.svg'},
    {'unselected': 'assets/svg/bottom_nav_unselected_appointment.svg', 'selected': 'assets/svg/bottom_nav_selected_appointment.svg'},
    {'unselected': 'assets/svg/bottom_nav_unselected_account.svg', 'selected': 'assets/svg/bottom_nav_selected_account.svg'},
    {'unselected': 'assets/svg/bottom_nav_unselected_profile.svg', 'selected': 'assets/svg/clinic.svg'},
  ];
              ...
              items: List.generate(_titles.length, (index) {
                ...
                if (index == _titles.length - 1) {
                  return BottomNavigationBarItem(
                    icon: CircleAvatar(
                      radius: 14,
                      backgroundColor: isSelected ? _selectedColors[index] : Colors.grey.shade300,
                      backgroundImage: homeProvider.profileImage != null
                          ? MemoryImage(homeProvider.profileImage!) // Profile Image from API
                      ...
                      child: homeProvider.profileImage == null
                          ...
                          ? SvgPicture.asset('assets/svg/bottom_nav_unselected_profile.svg', height: 22,
                        width: 22,)// Default avatar
                ...
                return BottomNavigationBarItem(
                  icon: SvgPicture.asset(
                    isSelected ? _icons[index]['selected']! : _icons[index]['unselected']!,
                    height: 22,
                    width: 22,
