...
//     // docIntr:(json['docIntr'] as List).map((i) => DoctorIntr.fromJson(i)).toList();
//     // clinics:(json['clinics'] as List).map((i) => Clinic.fromJson(i)).toList();
//   }
//
//   Map<String, dynamic> toJson() {
//     final Map<String, dynamic> homeData = new Map<String, dynamic>();
//     homeData['id'] = this.id;
//     homeData['firstName'] = this.firstName;
//     homeData['lastName'] = this.lastName;
//     homeData['degree'] = this.degree;
//     homeData['specialization'] = this.specialization;
//     homeData['experience'] = this.experience;
//     homeData['research_journal'] = this.research_journal;
//     homeData['citations'] = this.citations;
//     homeData['achievements'] = this.achievements;
//     homeData['licenceNumber'] = this.licenceNumber;
//     homeData['contact'] = this.contact;
//     homeData['email'] = this.email;
//     homeData['password'] = this.password;
//
//     return homeData;
//   }
//
...
// //       clinicList:
// //           (json['clinicList'] as List).map((i) => Clinic.fromJson(i)).toList(),
// //     );
// //   }
// // }
// //
...
// //       appointmentList: (json['appointmentList'] as List)
// //           .map((i) => Appointment.fromJson(i))
// //           .toList(),
// //       // prescriptionList: (json['prescriptionList'] as List).map((i) => Prescription.fromJson(i)).toList(),
// //       appointmentDto: (json['appointmentDto'] as List)
// //           .map((i) => AppointmentDto.fromJson(i))
// //           .toList(),
// //     );
// //   }
// // }
